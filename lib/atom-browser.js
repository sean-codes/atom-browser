...
export default {
   ...
   search(){
      var workspace = atom.workspace.open(this.view.workspace)
      this.view.html.addressbar.addEventListener('load', () => {
         this.view.html.addressbar.focus()
      })
      //this.view.html.addressbar.value = ''
   },
   devtools(){
