...
export default class AtomBrowserView {
   ...
   setListeners() {
      ...
      this.subscriptions.add(
         atom.commands.add('atom-workspace', {
            'atom-browser:preview': () => this.view.preview(),
            'atom-browser:reload': () => this.view.reload(),
            'atom-browser:devtools': () => this.view.devtools(),
            'atom-browser:search': () => this.view.search()
         }),
      )
   ...
   devtools() {
      ...
      this.html.webview.toggleDevTools()
   }
